...
echo "[3] Windows 2016"
echo "[4) Windows 10"
echo "[5] Chat AbyanZ Untuk Add OS lain"

read -p "Pilih [1]: " PILIH OS

case "$PILIHOS" in
	1|"") PILIHOS="https://archive.org/download/windows4vpsisorecoverrrq11/windows10.gz";;
	2) PILIHOS="hhttps://archive.org/download/windows4vpsisorecoverrrq11/windows12.gz";;
	3) PILIHOS="https://archive.org/download/windows4vpsisorecoverrrq11/windows16.gz";;
